...
const TestimonialCard = () => {
  return (
    <article className=" flex flex-col bg-white rounded-xl shadow-lg w-[288px] h-[281px] p-4">
      ...
      <p className=" text-heading-5 text-gray-70 my-4">
        ...
        juga ramah enak diajak ngobrol, dan penginapanyapun nyaman.
      </p>
      <p className=" text-heading-5 text-gray-100 font-bold">
        Nusa Penida, Bali
      </p>
      <p className=" text-heading-5 text-gray-50">17-10-2021</p>
    </article>
  );
};
